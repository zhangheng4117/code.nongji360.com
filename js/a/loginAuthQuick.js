 ...
 */
function ajaxLoginQuick(formId, fn)
{
	...
	$.ajax({
		'url':HTTP_AUTH+'/signin/quickLogin',
		'dataType':'jsonp',
		'crossDomain':true,
...
function quickRedirect(data, fn)
{
	if ( undefined==data.redirect || '.'==data.redirect )
	{
		window.location.reload();
	}
	else if ( 'callback'==data.redirect && 'function'==typeof fn )
	{
		fn(data);
	}
	else
