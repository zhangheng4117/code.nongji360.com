...
(function($){
	...
	setConfig = function(o){
		...
		config.multiple[index] = (config.multiple[index]===true || config.multiple[index]==="true" || config.multiple[index]==="multiple" || config.multiple[index]==="") && config.size[index]>1?true:false;
		...
		if(g.margin){config.margin=g.margin;}else{
			var _margin = o.css("marginTop")=="12px"?"0px":o.css("marginTop")+" "+o.css("marginRight")+" "+o.css("marginBottom")+" "+o.css("marginLeft");
