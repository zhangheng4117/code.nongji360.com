 ...
 * @param string | object container 容器,选择器或者jq对象
 * @Author: zhangheng
...
{
	var _this = this;
	$.post(_this.url, _this.data, function(data, status, xhr){
	...
	if( this.pages>1 )
	{
		if ( false===this.pageNumberCss )
		{
			pageHtml += '<style type="text/css">\
				#js-page-container{height:26px;line-height:26px;margin-top:5px;}\
